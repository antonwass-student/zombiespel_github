...
int main(int argc, char *argv[])
{
    ...
    //LEVEL
    player = createObject(&level, OBJECT_PLAYER, "Player 1",2800, 600, 128, 128, TXT_PLAYER, true);
    SetPlayerStats(&level.objects[player], 10000, 13, 4, 20, 0,CLASS_SOLDIER, 0.0, 30);
